...
#
# LAPIS MK715ボード上のLEDをBLE通信で制御します。
# 1. プログラムを実行するとBLEボードのスキャンを開始します。
# 2. デバイス名「cq_ex21_ble_led」を見つけると、ボード上のLEDを点滅制御します。
#
...
pi@raspberrypi:~/lapis_mk715 $ sudo ./ble_nordic_led.py
...
Device xx:xx:xx:xx:xx:xx (random), RSSI=-53 dB, Connectable=True
    9 Complete Local Name = cq_ex21_ble_led
    LED = OFF
...
[xx:xx:xx:xx:xx:xx][LE]> char-read-hnd 0010
