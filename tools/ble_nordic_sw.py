...
target_device  = ['cq_ex21_ble_led','cq_ex22_ble_sw']   # ここに接続するデバイス名を入力
...
while True:
    try:
        ...
        print(e,'\nblupy管理ERRORにつき下記コマンドを実行してください')
    ...
    for dev in devices:
        ...
        for (adtype, desc, value) in dev.getScanData():
            ...
            if adtype == 9 and (value in target_device or value == 'Nordic_Blinky'):
                isRohmMedal = value
            ...
            while True:
                ...
                if notified:
                    if notified_val == b'\x00':
                        ...
                        led = b'\x01'
                        print('    LED = ON')
                    # p.writeCharacteristic(0x0010, led)            # LED ON=1, OFF=0を送信する時
